...
age_gender = ['14-20m', '21-30m', '31-40m', '41-50m', '51-60m', '>=61m', '14-20f', '21-30f', '31-40f', '41-50f',
              '51-60f', '>=61f']
data = {}
tpeople = 0
data_games = {}
...
for user in db.readlines():
    ...
    rofls, country, age, gender, friends, heavy_plat, plat_arr, days_vk, ts_vk, days_feed, ts_feed, days_clips, ts_clips, days_video, ts_video, days_msg, ts_msg, days_games, ts_games, games_money_app, games_money_ad, total_money, games, cluster, interests = user
...
metric_names = ['Количество пользователей в возрастной группе', 'Суммарное время в видео', 'Суммарное время в клипах',
                ',metricname', 'Суммарная нерекламная выручка', 'Суммарная рекламная выручка', 'Суммарное время в ВК',
                'Суммарное время в играх', 'Средняя нерекламная выручка', 'Средняя рекламная выручка',
                'Среднее время в ВК', 'Среднее время в играх среди игроков', 'Средняя суммарная выручка в играх',
                'Среднее кол-во игроков', 'Среднее время в играх среди всех пользователей']
